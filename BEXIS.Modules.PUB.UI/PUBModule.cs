using BExIS.Modules.PUB.UI.Helpers;
using System;
using Vaiona.Logging;
using Vaiona.Web.Mvc.Modularity;

namespace BExIS.Modules.PUB.UI
{
    public class PUBModule : ModuleBase
    {
        public PUBModule() : base("PUB")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of PUB...");
        }
        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of PUB...");
            try
            {
                base.Install();
                using (PUBSeedDataGenerator generator = new PUBSeedDataGenerator())
                {
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of PUB...");
